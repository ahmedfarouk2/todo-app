...
window.addEventListener('load', (e) => {
  const savedProjectNames = JSON.parse(localStorage.getItem('Projects' || 0));
    ...
    projectNames[i].addEventListener('click', () => {
      ...
      addNewTask.addEventListener('click', (e) => {
        ...
        submitTaskButton.addEventListener('click', (e) => {
          ...
          const taskDate = moment__WEBPACK_IMPORTED_MODULE_0___default()().format(document.querySelector('#task-duedate').value);
          e.preventDefault();
